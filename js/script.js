    ...
    return (
      React.createElement("li", {
        ...
        React.createElement("article", { className: "slide__content" },
          ...
          React.createElement("button", { className: "slide__action btn", id: index }, button))));
...
bt0.addEventListener("click", function () { location.href = "bg_in.html" })
bt1.addEventListener("click", function () { location.href = "yuqi_catalog.html" })
bt2.addEventListener("click", function () { location.href = "summary.html" })
bt3.addEventListener("click", function () { location.href = "propose.html" })